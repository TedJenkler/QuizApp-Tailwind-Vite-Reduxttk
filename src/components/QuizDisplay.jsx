...
function QuizDisplay() {
  ...
  return (
    <main className={darkMode === "dark" ? "pt-8 px-6 bg-no-repeat bg-left-bottom md:pt-14 md:px-16 md:bg-left-top lg:px-36 bg-dark-navy bg-pattern-dark md:bg-pattern-dark-tablet h-full lg:h-screen pb-32" : "pt-8 px-6 bg-no-repeat bg-left-bottom md:pt-14 md:px-16 md:bg-left-top lg:px-36 bg-lightbg bg-pattern-light md:bg-pattern-light-tablet h-full lg:h-screen pb-32"}>
