...
function QuestionRenderer( {selectedTopic, selectedQ, setSelectedQ, choice, setChoice, points, setPoints} ) {
  ...
  return (
    <div className='lg:flex lg:gap-32'>
        ...
        <div className='lg:w-1/2'>
            <button onClick={(e) => {submited === false ? setChoice(state.options[0]): null}} className={`${darkMode === "dark" ? "flex items-center mb-3 justify-between p-3 rounded-xl w-full focus:border-purple focus:border-4 bg-navy shadow-2xl text-white md:mb-6" : "flex items-center justify-between mb-3 bg-pure-white p-3 rounded-xl w-full focus:border-purple focus:border-4 md:mb-6"}`}><div className='flex items-center'><img className='mr-3' src={a} alt='a' />{state.options[0]}</div>{choice === state.answer && choice === state.options[0] && submited === true ? <img src={right} alt='right answer' /> : null}{choice !== state.answer && choice === state.options[0] && submited === true ? <img src={wrong} alt='wrong answer' /> : null}</button>
            <button onClick={(e) => {submited === false ? setChoice(state.options[1]): null}} className={`${darkMode === "dark" ? "flex items-center mb-3 justify-between p-3 rounded-xl w-full focus:border-purple focus:border-4 bg-navy shadow-2xl text-white md:mb-6" : "flex items-center justify-between mb-3 bg-pure-white p-3 rounded-xl w-full focus:border-purple focus:border-4 md:mb-6"}`}><div className='flex items-center'><img className='mr-3' src={b} alt='b' />{state.options[1]}</div>{choice === state.answer && choice === state.options[1] && submited === true ? <img src={right} alt='right answer' /> : null}{choice !== state.answer && choice === state.options[1] && submited === true ? <img src={wrong} alt='wrong answer' /> : null}</button>
            <button onClick={(e) => {submited === false ? setChoice(state.options[2]): null}} className={`${darkMode === "dark" ? "flex items-center mb-3 justify-between p-3 rounded-xl w-full focus:border-purple focus:border-4 bg-navy shadow-2xl text-white md:mb-6" : "flex items-center justify-between mb-3 bg-pure-white p-3 rounded-xl w-full focus:border-purple focus:border-4 md:mb-6"}`}><div className='flex items-center'><img className='mr-3' src={c} alt='c' />{state.options[2]}</div>{choice === state.answer && choice === state.options[2] && submited === true ? <img src={right} alt='right answer' /> : null}{choice !== state.answer && choice === state.options[2] && submited === true ? <img src={wrong} alt='wrong answer' /> : null}</button>
            <button onClick={(e) => {submited === false ? setChoice(state.options[3]): null}} className={`${darkMode === "dark" ? "flex items-center mb-3 justify-between p-3 rounded-xl w-full focus:border-purple focus:border-4 bg-navy shadow-2xl text-white md:mb-8" : "flex items-center justify-between mb-3 bg-pure-white p-3 rounded-xl w-full focus:border-purple focus:border-4 md:mb-8"}`}><div className='flex items-center'><img className='mr-3' src={d} alt='d' />{state.options[3]}</div>{choice === state.answer && choice === state.options[3] && submited === true ? <img src={right} alt='right answer' /> : null}{choice !== state.answer && choice === state.options[3] && submited === true ? <img src={wrong} alt='wrong answer' /> : null}</button>
